...
-- START CHANGE SCRIPT #101: 101_adding-new-table.sql
...
INSERT INTO CHANGELOG (change_number, complete_dt, applied_by, description)
 VALUES (101, CURRENT_TIMESTAMP, USER(), '101_adding-new-table.sql');

COMMIT;

-- END CHANGE SCRIPT #101: 101_adding-new-table.sql
